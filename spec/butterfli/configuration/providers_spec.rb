...
describe Butterfli::Configuration::Providers do
  subject { Butterfli::Configuration::Providers }
  ...
  describe "#register_provider" do
    ...
    let(:provider_class) do
      stub_const 'TestProvider', Class.new(Butterfli::Configuration::Provider)
      TestProvider
    end
    ...
    context "when invoked with a provider name and class" do
      it do
        ...
        expect(Butterfli::Configuration::Providers.known_providers).to include(provider_name)
      end
    end
  end
  ...
  describe "#instantiate_provider" do
    ...
    before { Butterfli::Configuration::Providers.register_provider(:test_provider, provider_class) }
